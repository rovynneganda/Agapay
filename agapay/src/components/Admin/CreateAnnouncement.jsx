...
const CreateAnnouncement = () => {
  ...
  <div className=" py-5 px-4 mx-auto bg-white rounded-xl font-inter">
      <form action="#">
          <div className="flex flex-row gap-4 mb-5">
              <div className="w-full">
                  <label for="name" className="block mb-2 text-sm font-semibold text-black ">Title</label>
                  <input type="text" name="name" id="name" className="bg-subtlegray border border-gray/30 text-black text-sm rounded-lg focus:ring-primary focus:border-primary focus:outline-none block w-full p-2.5" required=""/>
              </div>
              <div className='w-full'> 
                  <label for="category" className="block mb-2 text-sm font-semibold text-black ">Category</label>
                  <select id="category" className="bg-subtlegray border border-gray/30 text-black text-sm rounded-lg focus:ring-primary focus:border-primary focus:outline-none block w-full p-2.5">
          ...
          <div className="">
                  ...
                  <textarea id="description" rows="8" className="block p-2.5 w-full text-sm text-black bg-subtlegray rounded-lg border border-gray/30 focus:ring-primary focus:outline-none focus:border-primary" ></textarea>
              </div>
