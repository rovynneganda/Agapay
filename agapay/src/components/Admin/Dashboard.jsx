...
const AdminDashboard = () => {
  return (
   <>
    ...
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Users</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <UserCircleIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Admin</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ClockIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Responders</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow ">
    <ShieldExclamationIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Incidents</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ChatBubbleBottomCenterIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Response</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ShieldCheckIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Total Resolution</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ChatBubbleLeftRightIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">User Feedback</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ChatBubbleOvalLeftEllipsisIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Average Response Time</p>
    </div>
</div>
<div class="max-w-xs p-6 bg-white border border-gray/20 rounded-lg shadow">
    <ClockIcon className='w-7 h-7 text-primary' />
        <div className='mx-auto justify-center text-center'>
        <h5 class="mb-2 text-4xl font-semibold tracking-tight font-inter">34 </h5>
    <p class="mb-3 font-normal text-lg font-poppins text-gray">Average Resolution Time</p>
    </div>
</div>
          </div>
          {/* ANALYTICS */}
