...
<Link  className="text-md font-poppins font-semibold text-secondary mr-3 hover:bg-lightgray px-2 py-2 rounded-lg " to="" >Login 
...
<Link  className="text-md font-poppins font-semibold text-primary mr-3 hover:bg-lightgray px-2 py-2 rounded-lg " to="" >Download 
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block ml-1">
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    <nav className="fixed top-0 w-full bg-primary z-10 mt-24">
            <div className="max-w-screen-xl px-4 py-3 mx-auto">
                 <button className="block sm:hidden  text-white bg-secondary py-2 px-2 rounded-lg" onClick={toggleNavbar}>
                       <img src={menu} alt="" />
                    </button>
                <div className="flex items-center justify-center sm:justify-between  flex-wrap">
                    ...
                    >
                        <li>
                            <Link className={`${styles.navLinks}`} to="/" onClick={toggleNavbar}>
                                Home
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link className={`${styles.navLinks}`} to="/about" onClick={toggleNavbar}>
                                About
                            </Link>
                        </li>
                    </ul>
