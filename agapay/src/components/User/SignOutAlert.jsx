...
const SignOutAlert = () => {
  ...
  >
    <div className="relative  max-w-md max-h-full">
      <div className="relative bg-white/20 rounded-lg shadow ">
        <div className="p-6 text-center">
          {/* <QuestionMarkCircleIcon className="h-12 w-12 mb-5 mx-auto text-primary animate-pulse" /> */}
          <button disabled type="button" className="text-white font-inter text-xl  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
