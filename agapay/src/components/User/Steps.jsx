...
<p className='mb-4 font-poppins flex flex-row whitespace-pre'>
    ...
    <div>
        <img src={weather} alt="Illustration" className=" h-64" />
    </div>
</div>
<div className="flex flex-col lg:flex-row sm:gap-5 md:gap-10 gap-0 justify-between items-center sm:py-14  p-5 bg-navprimary">
...
<div className="flex flex-col-reverse lg:flex-row sm:gap-5 md:gap-10 gap-0  items-center sm:py-14  p-5 bg-secondary">
    <div className='sm:ml-14 ml-0'>
        <img src={weather} alt="Illustration" className=" h-64" />
    </div>
    <div >
...
<div className="flex flex-col lg:flex-row sm:gap-5 md:gap-10 gap-0 justify-between items-center sm:py-14  p-5 bg-[#E49B0F]">
    <div className= ' sm:ml-14 ml-0'>
