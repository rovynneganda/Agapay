...
return {
  ...
  return (
    <div>
        <div className=' flex flex-row items-center justify-center sm:gap-10 gap-3 font-inter  text-white py-3'>
            {/* <img src="https://openweathermap.org/img/wn/2x.png" alt="" className='w-20' /> */}
            <p className='text-5xl font-inter '>{Math.round(data.celcius)}°C</p>
